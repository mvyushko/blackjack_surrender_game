...
player.wagers = {'Main Wager': {'White': 1, 'Pink': 51, 'Red': 0, 'Green': 0, 'Orange': 3, 'Amount': 128.5},
                 'Insurance': {'White': 0, 'Pink':0, 'Red': 0, 'Green': 10, 'Orange': 1, 'Amount': 0},
                 'Split Wager 1': {'White': 1, 'Pink': 51, 'Red': 0, 'Green': 0, 'Orange': 1, 'Amount': 128.5},
                 'Split Wager 2': {'White': 1, 'Pink': 51, 'Red': 0, 'Green': 0, 'Orange': 1, 'Amount': 128.5},
                 'Split Wager 3': {'White': 0, 'Pink':0, 'Red': 5, 'Green': 0, 'Orange': 1, 'Amount': 0}}
